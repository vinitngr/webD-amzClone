...
//                 matchingItem = products.find((product)=> product.id === cartItem.id)
//             })
//             deliveryOptions.forEach(option=>{
//                 deliveryOption = deliveryOptions.find(option => option.deliveryId == cartItem.deliveryOptionId);
//             })
...
//             let deliveryOption = deliveryOptions.find((option)=>option.deliveryId == cartItem.deliveryOptionId);
